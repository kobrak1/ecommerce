    ...
    <footer className="footer">
        ...
        <div className="container">
            ...
            <div className="footer-subscribe-wrapper">
                ...
                <div className="footer-subscribe-top">
                    ...
                    <p className="subscribe-desc">We&aposll email you a voucher worth $10 off your first order over $50.</p>
                </div>
        ...
        <div className="container">
            ...
            <div className="site-copyright">
                <p>
                Copyright 2023 © E-Commerce Theme. All right reserved. Powered by Burak Karhan.
                </p>
            </div>
            <a href="#">
